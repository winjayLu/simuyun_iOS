...
//  VKFramework
//
//  Created by cai liang on 14-9-27.
//  Copyright (c) 2014年 cai liang. All rights reserved.
//

#import "AGNumberForBank.h"
    //BIN号
    static long BankInfo[]=
    {
        102033,
        103000,
        185720,
    ...
    char* getNameOfBank(const char* charBin, int offset)
    {
        long longBin = 0;
        ...
        int index = binarySearch(BankInfo, longBin);
    ...
    //二分查找方法
    int binarySearch(long srcArray[], long des){
        int low = 0;
        int high =  1061 - 1;  //卡类型1061种
        while(low <= high)
        {
