...
//        }
	...
	selectNum = [[UIBarButtonItem alloc] initWithTitle:@"0/6" style:UIBarButtonItemStylePlain target:nil action:nil];
	...
	selectNum.title = [NSString stringWithFormat:@"%ld/6", (unsigned long)ASSETHELPER.selectdPhotos.count + (unsigned long)ASSETHELPER.selectdCameraPhoto.count];
}
...
- (NSMutableArray *)assets{
    NSLog(@"%zd",ASSETHELPER.selectdAssets.count);
