...
- (NSMutableArray *)selectdCameraPhoto{
    if (_selectdCameraPhoto==nil) {
        _selectdCameraPhoto = [[NSMutableArray alloc] init];
    }
    return _selectdCameraPhoto;
}
