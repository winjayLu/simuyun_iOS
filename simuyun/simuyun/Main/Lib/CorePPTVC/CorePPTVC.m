...
-(void)vcPrepare{
    ...
    //添加border
    [self.view setBorder:YTRGBA(0, 0, 0, 0.06f) width:0.5f];
}
...
-(void)timerOn{
    ...
    NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:4.0f target:self selector:@selector(timerRunAction) userInfo:nil repeats:YES];
