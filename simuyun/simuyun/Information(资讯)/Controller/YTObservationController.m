...
@interface YTObservationController ()
/**
 *  咨询列表
 */
...
@implementation YTObservationController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick event:@"artPanel_click" attributes:@{@"按钮" : @"云观察", @"机构" : [YTUserInfoTool userInfo].organizationName}];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [MobClick event:@"msg_click" attributes:@{@"类型" : @"云观察", @"机构" : [YTUserInfoTool userInfo].organizationName}];
}
